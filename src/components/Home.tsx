...
import { fetchTodoLists, createTodoList, updateTodoList, deleteTodoList } from "../api/todoList";
import {
  Box,
  Button,
  Card,
          ...
          <Card key={list.id}>
            ...
            <>
              ...
              <Stack direction="row" spacing={1}>
                <Button variant="outlined" onClick={() => navigate(`/todolist/${list.id}`)}>
                  Ver Tareas
                </Button>
                <Button variant="outlined" color="error" onClick={()=>handleDelete(list.id)}>
                  Eliminar
                </Button>
              </Stack>
            </CardContent>
